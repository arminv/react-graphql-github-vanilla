...
const resolveIssuesQuery = (queryResult, cursor) => (state) => {
  ...
  // Note: this means we are only fetching the first page (e.g. when page first mounts/loads, etc.):
  if (!cursor) {
    return {
    ...
    organization: {
      ...
      repository: {
        ...
        issues: {
          ...
          // Note: only the edges property should be updated with the merged list of issues:
          edges: updatedIssues,
        },
      },
    },
